...
* Propose an approach in plain language
...
Code without explanation is unacceptable.
...
* Cursor should propose multiple options when relevant
...
* Cursor should never override decisions without discussion
